...
$pageTitle = 'Страница не найдена — KROM Marketing';
$pageDescription = 'Запрашиваемая страница не найдена. Перейдите на главную страницу KROM Marketing или в блог.';
$pageCanonical = 'https://krommarketing.ru/404.php';
?>
<!DOCTYPE html>
<html lang="ru">
<head>
...
<section class="error404">
  <div class="error404__box">
    <div class="error404__code">404</div>
    <h1 class="error404__title">Страница не найдена</h1>
    <p class="error404__text">
      Похоже, такой страницы больше нет или ссылка ведёт не туда.
      Перейдите на главную страницу, в блог или напишите нам — подскажем нужный раздел.
    </p>

    <div class="error404__actions">
      <a class="btn-neon" href="/">На главную</a>
      <a class="btn-secondary" href="/blog.php">Перейти в блог</a>
      <a class="btn-secondary" href="https://t.me/krommarketing" target="_blank" rel="noopener">Написать в Telegram</a>
    </div>
  </div>
</section>
