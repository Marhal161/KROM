            ...
            <div class="services-grid">
                <article class="service-card">
                    ...
                    <div class="service-body">
                        ...
                        <h3>СМС-рассылка</h3>
                        <p class="service-desc">ХОТИТЕ УВЕЛИЧИТЬ КОНВЕРСИЮ ДО 30%? МЫ ПОМОЖЕМ ВАШЕМУ БИЗНЕСУ ДОСТИЧЬ НОВЫХ ВЫСОТ С ПОМОЩЬЮ ЭФФЕКТИВНЫХ СМС-КАМПАНИЙ.</p>
